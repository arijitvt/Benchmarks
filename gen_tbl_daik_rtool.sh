...
echo "$NAME &  $LOC & $PRG_POINTS & $GLOBALS &  $DAIK_TTL_INV & $HAPSET_TTL_INV & $PCB_TTL_INV & $DPOR_TTL_INV & $CORRECT_INV & $CORRECT_INV & $CORRECT_INV & $CORRECT_INV & $DAIK_NUM_RUNS & $HAPSET_NUM_RUNS & $PCB_NUM_RUNS & $DPOR_NUM_RUNS & $DAIK_TIME & $HAPSET_TIME & $PCB_TIME & $DPOR_TIME \\\\"
